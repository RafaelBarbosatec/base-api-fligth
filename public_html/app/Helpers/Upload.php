<?php
    /*include_once('../../libextras/WideImage/WideImage.php');*/
/**
 * Upload.class [ HELPER ]
...
class Upload {
     ...
     */
         ...
         public function File(array $File, $Name = null, $Folder = null, $MaxFileSize = null){
            ...
            if($this->File['size'] > ($MaxFileSize * (1024 * 1024))){
                ...
                $this->Result = false;
                $this->Error  = 'Tipo de arquivo não suportado. Envie um arquivo do tipo .PDF ou DOCX!';
     ...
     */
        ...
        public function Media(array $Media, $Name = null, $Folder = null, $MaxFileSize = null){
            ...
            if($this->File['size'] > ($MaxFileSize * (1024 * 1024))){
                ...
                $this->Result = false;
                $this->Error  = 'Tipo de arquivo não suportado. Envie um arquivo do tipo audio MP3 ou MP4!';
    ...
    private function setFileName(){
        $FileName = Check::Name($this->Name) . strrchr($this->File['name'], '.'); // Encontra a ultima ocorrencia de um caractere em uma string
    ...
    private function UploadImage(){
        ...
        if(!$this->Image):
            ...
            $ImageH = ($ImageX * $y) / $x;
           // $ImageH = ($this->Width < $x ? $this->Width : $x);
        ...
        endswitch;
            ...
            imagedestroy($this->Image); // Esvaziando espaço da memoria.
