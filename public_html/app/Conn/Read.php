...
/*
*Faz um select especifico!
*Lembrando que ja existe um metodo FullRead() que e personalizavel
*/
    public function ExeReadEditable($Select, $Tabela, $Termos = null, $ParseString = null) {
        if (!empty($ParseString)):
            parse_str($ParseString, $this->Places);
        endif;
